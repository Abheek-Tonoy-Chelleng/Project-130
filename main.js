...
function draw(){
    ...
    song_Star_boy = Star_boy_song.isPlaying();
    console.log(song_Star_boy);
    ...
    if(scoreleftWrist > 0.2){
        ...
        if(song_Star_boy == false){
            Star_boy_song.play();
        }
        else{
            console.log("Song Name: Starboy Song");
            document.getElementById("song_id").innerHTML = "Song Name: Starboy Song";
        }
    }
